...
> `v0.3.0-beta.6` is the next preview beta. It adds per-session 1.26.45/2169 support, pins
...
| Review the next beta and upgrade steps | [v0.3.0-beta.6 release notes](releases/v0.3.0-beta.6.md) |
...
| Application release | `v0.2.0` stable; `v0.3.0-beta.6` next preview beta |
