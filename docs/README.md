...
> `v0.3.0-beta.3` is the current preview beta. It adds per-session 1.26.44/2168 and
> 1.26.50/2192 client negotiation against the locked 1.26.44.3 backend, plus dashboard module
> controls. New mutation-capable modules remain disabled by default.
...
| Review the current beta and upgrade steps | [v0.3.0-beta.3 release notes](releases/v0.3.0-beta.3.md) |
...
| Application release | `v0.2.0` stable; `v0.3.0-beta.3` preview beta |
