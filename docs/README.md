...
> `v0.3.0-beta.9` is the next preview beta. It adds per-session 1.26.45/2169 support, pins
...
| Review the next beta and upgrade steps | [v0.3.0-beta.9 release notes](releases/v0.3.0-beta.9.md) |
...
| Application release | `v0.2.0` stable; `v0.3.0-beta.9` next preview beta |
