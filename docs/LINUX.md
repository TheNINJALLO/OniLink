...
The `v0.1.2` library is ELF64 little-endian x86-64. Verify its SHA-256 against the release's `SHA256SUMS`; the final value is also recorded in the [v0.1.2 release notes](releases/v0.1.2.md).
