...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1.26.44.3 | `06effdd00067f1ae0951ee7a732398dde721728e6b18ea149b138b8e2aececa7` | Linux x86-64/System V, glibc 2.35+ | 0.11.9 (`a73f76d3725b471a6d83783166edc004804faa1b`) | `onibridge-0.1.4-bds-1.26.44.3-linux-x86_64.so` | production-approved | passed on GitHub Ubuntu 22.04 with ABI ceiling check | complete matrix operator-approved | operator-approved |
