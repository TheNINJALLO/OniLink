...
Download `egg-onilink.json` from the [current release](https://github.com/TheNINJALLO/OniLink/releases/tag/v0.1.0-candidate.3) or [`packaging/pterodactyl`](../packaging/pterodactyl/README.md).
