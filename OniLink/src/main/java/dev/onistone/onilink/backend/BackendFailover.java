...
import dev.onistone.onilink.config.FailoverConfig;
import dev.onistone.onilink.config.ProtocolFaultPolicy;
import dev.onistone.onilink.diagnostics.ProtocolFault;
import dev.onistone.onilink.diagnostics.ProtocolFaultLog;
