...
import dev.onistone.onilink.config.BackendSwitchConfig;
import dev.onistone.onilink.config.ForcedHostsConfig;
import dev.onistone.onilink.config.ProxyPolicy;
import dev.onistone.onilink.auth.OfflineLoginForge;
import dev.onistone.onilink.forwarding.OniForwardTokenFactory;
...
public final class BackendConnector {
    ...
    private org.cloudburstmc.protocol.bedrock.packet.LoginPacket backendLogin(
        ...
        String oniForward = forwardingTokenFactory.issue(
                backendConfig,
                connection.clientLogin().authData(),
                connection.forwardingSessionId(),
