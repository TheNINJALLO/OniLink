 ...
 *
 * <p>Implement this, name the class in an {@code onilink-plugin.properties} at the root of your jar,
 * and OniLink will find and enable it at startup &mdash; no configuration, no flags. An empty or
 * missing {@code plugins/} directory means OniLink runs as a plain Bedrock proxy, with no branch
 * anywhere else in the code.</p>
 *
 * <pre>
 * onilink-plugin.properties:
 *   name=MyAddon
