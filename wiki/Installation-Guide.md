...
> [!IMPORTANT]
> `v0.1.0-candidate.1` is not production-approved. Native BDS testing requires the exact BDS `1.26.44.3` Linux executable, Endstone `0.11.9`, the candidate opt-in, and completion of the live test matrix.
