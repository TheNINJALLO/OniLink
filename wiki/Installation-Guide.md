...
> [!IMPORTANT]
> `v0.1.5` is the production release for the exact BDS `1.26.44.3` Linux executable and Endstone `0.11.9`. Keep the unreviewed-profile override disabled; mismatched native targets remain blocked.
