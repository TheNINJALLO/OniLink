...
> [!IMPORTANT]
> `v0.1.3` is the current production release. It adds first-class secure backend onboarding while retaining authenticated XUID allowlisting, stable startup updates, and the reviewed Linux BDS `1.26.44.3` + Endstone `0.11.9` profile.
...
| Item | Value |
| --- | --- |
| Application release | [`v0.1.3`](https://github.com/TheNINJALLO/OniLink/releases/tag/v0.1.3) |
| BDS | `1.26.44.3` |
| Endstone | `0.11.9` |
