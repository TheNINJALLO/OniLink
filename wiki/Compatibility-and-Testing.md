...
| --- | --- | --- |
| Linux BDS `1.26.44.3` + Endstone `0.11.9` | Native Ubuntu 22.04 build, maximum `GLIBC_2.35` import, C++ unit tests, synthetic hook harness, operator-reported valid proxied join | Human profile review and complete recorded live BDS matrix |
